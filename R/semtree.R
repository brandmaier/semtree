...
#' @param data A \code{data.frame} used for growing the tree. The order
...
#' @param control A \code{\link{semtree_control}} object contains all hyper-parameters that govern the splitting procedure.
...
#' @param predictors A vector of variable names matching variable names in the
#' data set. If NULL (default) all variables that are in data set and not part of
#' the model are potential predictors. 
#' @param \dots Optional arguments.
#' @return A \code{semtree} object. This can be further examined with
