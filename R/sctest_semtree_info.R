sctest_semtree_info <- function(CSP, covariate, functional_string, scaled_split,
                                from, to) {

  # Continuous covariate
  if (functional_string == "dm") {
    CSP <- CSP[-1, ]
    abs_CSP <- abs(x = CSP)
