...
Create a forest control object that stores all tuning parameters of the forest. Note that we use only 10 trees for demo purposes. Please increase the number in real applications.

```{r}
control <- semforest.control(num.trees = 10)
print(control)
```
